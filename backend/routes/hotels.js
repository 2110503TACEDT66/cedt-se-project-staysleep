...
const {getHotels,getHotel,createHotel,updateHotel,deleteHotel,getTags,createTags} = require('../controllers/hotels');
...
// tags
router.route('/tags').get(getTags).post(protect, authorize('admin'), createTags);
